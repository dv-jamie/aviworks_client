                ...
                <section className={styles.intro}>
                    <div className={styles.content_wrap}>
                        <div className={styles.title_wrap}>
                            ...
                            <h3>AI 기반 다 시점 3D 골프 스윙 분석 서비스</h3>
                        </div>
                ...
                <section className={styles.summary}>
                    <div className={styles.content_wrap}>
                        ...
                        <div className={styles.detail_wrap}>
                            <ul>
                                <li>
                                    <div className={styles.title}>AI 기반 3D 입체 분석 제공</div>
                                    <p>생체역학을 바탕으로 체계적이고 정밀한 분석을 제공합니다</p>
                                </li>
                                <li>
                                    <div className={styles.title}>100여 개의 분석 데이터 제공</div>
                                    <p>
                                ...
                                <li>
                                    <div className={styles.title}>정밀 수치 데이터 제공</div>
                                    <p>
                        ...
                        <ul>
                            <li>
                                ...
                                <div className={styles.text_wrap}>
                                    ...
                                    <p>정확하고 체계적인 코칭 및 학습 기회 제공</p>
                                    <p className={styles.caption}>손목 각도 변화 그래프를 이용한 Casting 여부 판단</p>
                                </div>
                            </li>
                            <li>
                                <div className={styles.text_wrap}>
                                    <div className={styles.title}>정밀 데이터 제공</div>
                                    <p>
                                        회전(Turn), 각도(Angle), 헤드업, 스웨이,<br />
                                        X-Factor 등
                                    </p>
                                    <p className={styles.caption}>잘못된 2D 기반 스윙 분석 이슈 해결</p>
                                </div>
                                <div className={styles.image_wrap}>
                ...
                <section className={`${styles.intro} ${styles.a_scount}`}>
                    <div className={styles.content_wrap}>
                        ...
                        <div className={styles.title_wrap}>
                            ...
                            <h3>다양한 Sports에 특화된 고속/정밀 영상 촬영 카메라</h3>
                        </div>
                    </div>
                </section>
                {/* Intro Section 끝 */}
                ...
                <section className={styles.summary}>
                    <div className={styles.content_wrap}>
                        ...
                        <div className={styles.detail_wrap}>
                            <ul>
                                <li>
                                    <div className={styles.title}>고속 정밀 촬영</div>
                                    <p>
                                ...
                                <li>
                                    <div className={styles.title}>골프 스윙 분석에 최적화된 영상</div>
                                    <p>
                        ...
                        <ul className={styles.value_list}>
                            <li>
                                ...
                                <ul className={styles.detail_list}>
                                    <li>매년 증가하는 라운딩 비용을 줄여 줍니다</li>
                                    <li>워킹 골프를 통하여 건강도 지키고 캐디비와 카트비를 줄여 보세요</li>
                                </ul>
                            </li>
                            <li>
                                <div className={styles.title_wrap}>
